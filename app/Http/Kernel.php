...
use App\Http\Middleware\MerchantRedirectIfNotAuthenticated;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'merchant' => MerchantRedirectIfNotAuthenticated::class,
        'merchant' => MerchantRedirectIfAuthenticated::class,
